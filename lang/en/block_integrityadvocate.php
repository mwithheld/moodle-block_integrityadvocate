...
$string['no_modules_config_message'] = 'There are no modules found with activity completion enabled which have the ' . $string['pluginname'] . ' block set up.';
...
$string['privacy:metadata:block_integrityadvocate:override_date'] = 'If applicable, the date the ' . $string['pluginname'] . ' status is overridden by an instructor.';
...
$string['privacy:metadata:block_integrityadvocate:override_status'] = 'If applicable, the ' . $string['pluginname'] . ' status applied by the override.';
