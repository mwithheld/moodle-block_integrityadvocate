                ...
                init: function() {
                    ...
                    if ($('body').hasClass('block_integrityadvocate-overview-course')) {
                        ...
                        $('#participants').DataTable({
                            ...
                            'info': false,
                            'language': {'search': M.util.get_string('moodle', 'filter') + '&nbsp;'},
                    ...
                    if ($('body').hasClass('block_integrityadvocate-overview-user')) {
                        ...
                        class OverrideUi {
                            ...
                            overrideuiSetup(elt) {
                                debug && window.console.log('overrideui::overrideuiSetup::Started');
                                var self = this;
                                ...
                                this.frm.eltReason
                                        ...
                                        .on('keyup keypress', function(e) {
                                            ...
                                            debug && window.console.log('overrideui::overrideuiSetup::Enter pressed');
                                            if (keyCode === 13) {
                                ...
                                debug && window.console.log('overrideui::overrideuiSetup::Built frm', this.frm);
                                ...
                                this.frm.eltSave.on('click', function(e) {
                                    debug && window.console.log('overrideui::overrideuiSetup::eltSave.on.click()::Started');
                                    if (self.validateAll()) {
                                        self.saveClick();
                                    }
                            ...
                            saveClick() {
                                var self = this;
                                this.inputsDisable();
                                debug && window.console.log('overrideui::saveClick::Started with frm=', this.frm);
                                ...
                                require(['core/ajax'], function(ajax) {
                                    ajax.call([{
                                            ...
                                            args: {
                                                ...
                                                debug && window.console.log('overrideui::saveClick::ajax.done');
                                            ...
                                            fail: function(xhr_unused, textStatus, errorThrown) {
                                                debug && window.console.log('overrideui::saveClick::ajax.always');
                                ...
                                debug && window.console.log('overrideui::saveClick::Done');
                            }
                            ...
                            validateReason() {
                                ...
                                debug && window.console.log('overrideui::validateReason::Started with frm=', this.frm);
                                debug && window.console.log('overrideui::validateReason::Started with elt=', elt);
